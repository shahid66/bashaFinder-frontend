  ...
  return (
    <div className="py-16 bg-gray-100">
      <div className="container mx-auto text-center">
        {/* Title */}
        <h2 className="text-4xl font-bold mb-4 text-gray-900">Some Reviews</h2>
        <p className="text-gray-600 text-lg mb-8">What our customers say</p>
        <Swiper
          navigation
            ...
            <SwiperSlide key={index}>
              <Card className="bg-white shadow-lg rounded-lg p-6 text-center">
                <div className="flex flex-col items-center">
                  ...
                  {/* Name & Position */}
                  <h3 className="text-lg font-bold mt-3">{testimonial.name}</h3>
